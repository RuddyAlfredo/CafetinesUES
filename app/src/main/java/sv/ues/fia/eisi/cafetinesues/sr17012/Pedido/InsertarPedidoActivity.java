...
import sv.ues.fia.eisi.cafetinesues.sr17012.Combo.ActualizarComboActivity;
import sv.ues.fia.eisi.cafetinesues.sr17012.Combo.Combo;

public class InsertarPedidoActivity extends Activity implements CuadroDialogo.recibirValor{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insertar_pedido);
        ...
        editIdProductoSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(editIdProductoSpinner.getSelectedItemPosition() != 0) {
                    String type =  productosObj.get(position).getIdTipoProducto();
                    ...
                    new CuadroDialogo(InsertarPedidoActivity.this, InsertarPedidoActivity.this, "p");
                }
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {}
        ...
        editIdComboSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(editIdComboSpinner.getSelectedItemPosition() != 0) {
                    ...
                    new CuadroDialogo(InsertarPedidoActivity.this, InsertarPedidoActivity.this, "c");
                }
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {}
        ...
        listaProductos.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView adapterView, View view, int i, long l) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(InsertarPedidoActivity.this);
