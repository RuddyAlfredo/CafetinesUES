...
public class PedidoMenuActivity extends ListActivity {
    ...
    int[] idsPermisos = {33,34,35};// IDS de los permisos
    String[] opcionesDisponibles = {"Insertar Pedio","Consultar Pedio","Borrar Pedio","Actualizar Pedio"};

    ArrayList<String> menuActivities = new ArrayList<String>(); // menu a llenar con las activities permitidas.
    String[] activities = {"InsertarPedidoActivity","ConsultarPedidoActivity","EliminarPedidoActivity", "ActualizarPedidoActivity"};
    ...
    protected void onListItemClick(ListView l, View v, int position, long id){
        ...
        try{
            Class<?> clase=Class.forName("sv.ues.fia.eisi.cafetinesues.sr17012.Pedido."+nombreValue);
