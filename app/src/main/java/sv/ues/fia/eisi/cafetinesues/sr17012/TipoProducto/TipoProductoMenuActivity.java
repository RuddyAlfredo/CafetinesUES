...
public class TipoProductoMenuActivity extends ListActivity {
    ...
    int[] idsPermisos = {57,58,59,60};// IDS de los permisos
    String[] opcionesDisponibles = {"Insertar Tipo de Producto","Consultar Tipo de Producto","Borrar Tipo de Producto","Actualizar Tipo de Producto"};

    ArrayList<String> menuActivities = new ArrayList<String>(); // menu a llenar con las activities permitidas.
    String[] activities = {"InsertarTipoProductoActivity","ConsultarTipoProductoActivity","EliminarTipoProductoActivity", "ActualizarTipoProductoActivity"};
    ...
    protected void onListItemClick(ListView l, View v, int position, long id){
        ...
        try{
            Class<?> clase=Class.forName("sv.ues.fia.eisi.cafetinesues.sr17012.TipoProducto."+nombreValue);
